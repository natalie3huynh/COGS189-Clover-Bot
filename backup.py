...
# # #Send data to server
# def send_data_to_server(button_id):
#     sio.emit('data', {'button_id': button_id})
...
#                 send_data_to_server(eeg_in.tolist()) #list conversion for JSON compatibility --> check 
#             time.sleep(0.1)
...
#     #phase shift is needed to differentiate phase shifted version of hz 
